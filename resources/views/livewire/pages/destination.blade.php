<main>
    ...
    <header class="pageMainHead d-flex position-relative bgCover w-100 text-white"
        ...
        <div class="alignHolder d-flex w-100 align-items-center">
            <div class="align w-100 position-relative">
                <div class="container">
                    <h1 class="text-white mb-2">Destination Details</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrWhite rounded-0 border-0 p-0 fontAlter mb-0">
                            <li class="breadcrumb-item"><a href="/">Home</a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Tourism</a></li>
            ...
            <div class="row">
                <div class="col-12 col-md-7 col-lg-8 col-xl-9">
                    <header class="fzMedium mb-6">
                        <h2 class="h2vii fwSemiBold mb-3 mb-md-5 mb-xl-8">Description of Destination</h2>
                ...
                <div class="col-12 col-md-5 col-lg-4 col-xl-3">
                    <div class="widget psShareWidget shadow bg-white mt-5 mt-md-0 px-4 px-lg-6 pt-7 pb-8">
                        <ul class="psMetaList list-unstyled p-0 m-0">
                            <li>
                                <strong class="d-block fwSemiBold text-lDark mb-1 fontAlter">Sub-County:</strong>
                                <span class="d-block">Teso North</span>
                            </li>
                            <li>
                                <strong class="d-block fwSemiBold text-lDark mb-1 fontAlter">Founded:</strong>
                                <span class="d-block">12 March 2020</span>
                            </li>
                            <li>
                                <strong class="d-block fwSemiBold text-lDark mb-1 fontAlter">Location:</strong>
                                <span class="d-block">Kakapel Hills</span>
                            </li>
                            <li>
                                <strong class="d-block fwSemiBold text-lDark mb-1 fontAlter">Apx. Visitors:</strong>
                                <span class="d-block">100,000 / Year</span>
                            </li>
                            <li>
    ...
    <section class="bgLight pt-8 pt-md-12 pt-xl-16 pb-4 pb-md-8 pb-xl-16">
        <div class="container">
            <h2 class="text-center h2vii fwSemiBold mb-5 mb-md-8">Other Destinations</h2>
            <div class="row">
                        ...
                        <div class="echcCaptionWrap position-absolute w-100 text-white px-3 py-2 px-sm-5 py-sm-4">
                            <h3 class="mb-0 text-white">
                                <strong class="d-block font-weight-normal fontBase echCatTitle mb-1">Public
                                    Places</strong>
                                <span class="d-block">Teso South</span>
                            </h3>
                            <a href="{{route('destination')}}"><i
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="echColumn echColumnii d-block w-100 bgCover position-relative mb-6"
                        ...
                        <div class="echcCaptionWrap position-absolute w-100 text-white px-3 py-2 px-sm-5 py-sm-4">
                            <h3 class="mb-0 text-white">
                                <strong class="d-block font-weight-normal fontBase echCatTitle mb-1">Budalangi</strong>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="echColumn echColumnii d-block w-100 bgCover position-relative mb-6"
                        ...
                        <div class="echcCaptionWrap position-absolute w-100 text-white px-3 py-2 px-sm-5 py-sm-4">
                            <h3 class="mb-0 text-white">
                                <strong class="d-block font-weight-normal fontBase echCatTitle mb-1">Nambale</strong>
