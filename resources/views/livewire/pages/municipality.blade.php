    ...
    <header class="pageMainHead d-flex position-relative bgCover w-100 text-white"
        ...
        <div class="alignHolder d-flex w-100 align-items-center">
            <div class="align w-100 position-relative">
                <div class="container">
                    <h1 class="text-white mb-2">Municipalities</h1>
    ...
    <article class="dsSingleContent pt-7 pb-2 pt-md-10 pb-md-1 pt-lg-16 pb-lg-10 pt-xl-21 pb-xl-16">
        <div class="container">
                ...
                <div class="col-12 col-lg-8 col-xl-9 order-lg-2 mb-6">
                    <div class="pl-xl-14">
                        ...
                        <div class="overflow-hidden mb-3 mb-lg-7">
                            <div
                                class="dscInnerSliderWrap float-sm-right mb-7 mb-sm-0 mt-sm-2 ml-auto mr-auto mr-sm-0 ml-sm-6">
                                <div class="dcsInnSlider">
                                    <div>
                                        <div class="dcsisImageHolder">
                                            <img src="{{asset('assets/images/img33.jpg')}}" class="img-fluid w-100"
                                                alt="image description">
                                        </div>
                                    </div>
                                    <div>
                                        <div class="dcsisImageHolder">
                                            <img src="{{asset('assets/images/img34.jpg')}}" class="img-fluid w-100"
                                                alt="image description">
                                        </div>
                                    </div>
                                </div>
            ...
            <section class="bgLight pt-8 pt-md-12 pt-xl-16 pb-4 pb-md-8 pb-xl-16">
                <div class="container">
                    <h2 class="text-center h2vii fwSemiBold mb-5 mb-md-8">Facilities</h2>
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="echColumn echColumnii d-block w-100 bgCover position-relative mb-6"
                                ...
                                <div
                                    ...
                                    <h3 class="mb-0 text-white">
                                        <strong
                                            class="d-block font-weight-normal fontBase echCatTitle mb-1">Budalangi</strong>
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="echColumn echColumnii d-block w-100 bgCover position-relative mb-6"
                                ...
                                <div
                                    ...
                                    <h3 class="mb-0 text-white">
                                        <strong
                                            class="d-block font-weight-normal fontBase echCatTitle mb-1">Nambale</strong>
            ...
            <section class="meetCouncilBlock noOverlay position-relative pt-3 pt-md-4 pt-lg-6 pt-xl-11 pb-6 pb-lg-10">
                <div class="container">
                    <header class="headingHead text-center cdTitle mb-7 mb-md-13">
                        <h2 class="fwSemiBold mb-4">Leadership Board</h2>
