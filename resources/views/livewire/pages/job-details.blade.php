    ...
    <header class="pageMainHead d-flex position-relative bgCover w-100 text-white"
        ...
        <div class="alignHolder d-flex w-100 align-items-center">
            <div class="align w-100 position-relative">
                <div class="container">
                    <h1 class="text-white mb-2">Documents</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrWhite rounded-0 border-0 p-0 fontAlter mb-0">
                            <li class="breadcrumb-item"><a href="/">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{route('jobs')}}">Careers</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Job Details Page</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-8 col-xl-9 order-lg-2 mb-6">
                    <div class="pl-xl-14">
                        <header class="docHeadingHead mb-6">
                            <h2 class="h2vii fwSemiBold mb-1">Job Details Page</h2>
                            <p>Aug 11, 2020 - In <a href="javascript:void(0);" class="text-lDark">Public Works</a></p>
                            <div class="fzMedium">
                        ...
                        <p>Thomas Edison may have been behind the invention of the electric light bulb, but he did not
                            work alone. Edison worked alongside partners, both financial and commercial, to get his
                            inventions off the ground. It was installed globally, an annual market growth of 22 percent.
                            It is continuing its progress towards becoming a mainstream competitive salary and economy
                            reports by mine.</p>
                        <ul class="list-unstyled listDefault mb-9">
                            <li>A three-party relationship – the responsible party who prepares the information to be
                                assured; the independent practitioner who assures the information.</li>
                            <li>Agreed subject matter – in the case of an audit, this would be the annual accounts of a
                                company. However it could be almost anything in practice – the systems operated by a
                                state lottery, a company’s greenhouse gas emissions, controls over a supply chain etc.
                            </li>
                            <li>Systems operated by a state lottery, a company’s greenhouse gas emissions, controls.
                            </li>
                        </ul>
                        ...
                        <aside class="saShareAside d-flex justify-content-between text-center align-items-center">
                            <strong class="d-block text-lDark fwSemiBold fontAlter title mb-2">Share Job</strong>
                            <ul
                ...
                <div class="col-12 col-lg-4 col-xl-3 order-lg-1 mb-6 position-static">
                    <aside class="dscSidebar pt-1 mr-xl-n5">
                        <nav class="widget mb-6 mb-lg-10 widgetDepartsNav widgetBgLight py-3 py-lg-5 px-6">
                            <h3 class="fwSemiBold mb-4 position-relative">Job Menu</h3>
                            <ul class="list-unstyled pl-0 mx-n2 mb-0 mb-3">
                                <li>
                                    <a href="javascript:void(0);">All Documents</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);">Business Reports</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);">Finance &amp; Economy</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);">City Reports</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);">Roads &amp; Transport</a>
                                </li>
                            </ul>
                        </nav>
